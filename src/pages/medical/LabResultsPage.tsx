...
export function LabResultsPage() {
  ...
  const handleEdit = (labResult: LabResult) => {
  ...
  return (
    <MainLayout
      pageTitle="Lab Results Management"
      pageAction={
            ...
            {selectedPatient ? (
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search patient to manage lab results..."
        ...
        {!selectedPatientId ? (
          <div className="text-center py-16">
            ...
            <p className="text-zinc-600 max-w-md mx-auto">
              Enter a patient name, phone number, email, or medical record number above to view and manage their lab results.
            </p>
          </div>
        ) : (
          <>
            <div className="text-[12px] font-medium text-zinc-500 uppercase tracking-wider px-1">
              Lab Results ({pagination.totalElements} total)
            </div>
            <LabResultsTable
              labResults={labResults}
              onEdit={handleEdit}
              onDelete={async (labResult) => {
                if (!confirm(`Are you sure you want to delete this lab result?`)) return;
                try {
                  await labResultsService.deleteLabResult(labResult.id);
