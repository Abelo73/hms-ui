...
export function AllergiesPage() {
  ...
  return (
    <MainLayout
      pageTitle="Allergies Management"
      pageAction={
            ...
            {selectedPatient ? (
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search patient to manage allergies..."
        ...
        {!selectedPatientId ? (
          <div className="text-center py-16">
            ...
            <p className="text-zinc-600 max-w-md mx-auto">
              Enter a patient name, phone number, email, or medical record number above to view and manage their allergies.
            </p>
          </div>
        ) : (
          <>
            <div className="text-[12px] font-medium text-zinc-500 uppercase tracking-wider px-1">
              Allergies ({pagination.totalElements} total)
            </div>
            <AllergiesTable
              allergies={allergies}
              onEdit={handleEdit}
              onDelete={async (allergy) => {
                if (!confirm(`Are you sure you want to delete this allergy?`)) return;
                try {
                  await allergiesService.deleteAllergy(allergy.id);
